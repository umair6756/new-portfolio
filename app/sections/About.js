...
//                 className="absolute -bottom-6 -right-6 bg-[var(--surface)] p-6 rounded-lg shadow-xl w-3/4 border border-[var(--border)]"
//               >
//                 <h3 className="text-xl font-bold text-[var(--text-primary)] mb-2">5+ Years Experience</h3>
//                 <p className="text-[var(--text-secondary)]">Working with cloud technologies and DevOps practices</p>
//               </motion.div>
//             </div>
//           </motion.div>
...
//                   I'm a DevOps Engineer based in San Francisco, specializing in cloud infrastructure, automation, and CI/CD pipelines. 
...
//                   { label: "Email", value: "alex@devopsengineer.com" },
//                   { label: "From", value: "San Francisco, USA" },
//                   { label: "Availability", value: "Open to opportunities" }
//                 ].map((item, index) => (
//                   <AnimatedCard key={index} className="p-4" delay={0.1 + index * 0.05}>
//                     <h4 className="text-[var(--primary)] font-bold mb-2">{item.label}</h4>
...
//                 <h3 className="text-2xl font-bold text-[var(--text-primary)] mb-4">What I Do?</h3>
//                 <div className="space-y-4">
//                   <div className="flex items-start gap-4">
//                     <div className="text-[var(--primary)] text-2xl mt-1">☁️</div>
//                     <div>
//                       <h4 className="text-[var(--primary)] font-bold mb-2">Cloud Infrastructure</h4>
//                       <p className="text-[var(--text-secondary)]">
//                         Design and implement scalable cloud architectures on AWS, GCP, and Azure.
//                       </p>
//                     </div>
//                   </div>
//                   <div className="flex items-start gap-4">
//                     <div className="text-[var(--primary)] text-2xl mt-1">🔄</div>
//                     <div>
//                       <h4 className="text-[var(--primary)] font-bold mb-2">CI/CD Pipelines</h4>
//                       <p className="text-[var(--text-secondary)]">
//                         Build automated deployment pipelines for rapid and reliable software delivery.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
